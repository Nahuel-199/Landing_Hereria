    ...
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact_content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              herreriaycontruccionelorion@gmail.com
              </span>

              <a 
              href="herreriaycontruccionelorion@gmail.com" 
              target="_blank" 
              rel="noreferrer" 
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">herreriayconstrusccionelorion</span>

              <a href="https://www.instagram.com/herreriayconstrusccionelorion/" 
              target="_blank" 
              rel="noreferrer" 
              className="contact__button"
              >
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Herreria Orion</span>

              <a href="https://www.facebook.com/profile.php?id=100091941567683"  
              target="_blank" 
              rel="noreferrer" 
              className="contact__button"
              >
        ...
        <div className="contact__content">
          <h3 className="contact__title">Escríbeme tu consulta</h3>
